...
const (
	...
	ENDPOINT_ID   = "IPxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
	DEP_ROLE_SID  = "DRxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
	PUSH_CRED_SID = "PCxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
	PROFILE_SID   = "PSxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
)
